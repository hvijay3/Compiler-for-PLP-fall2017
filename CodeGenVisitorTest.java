...
public class CodeGenVisitorTest implements ImageResources{
	...
	public void prog9() throws Exception {
		...
		String prog = "prog12";
		String input = prog+
				"\nboolean b1;\nb1 <- @ 0;\nboolean b2;\nb2 <- @ 1;\nboolean b3;\nb3 <- @ 2;\nboolean output1 = (b1 & b2) | (b2 | b3) ;\nboolean output2 = (b1 | b2) | (b2 & b3) ;\nboolean output;\noutput = !(!(output1) | !(output2));\noutput -> SCREEN;";
					
		//show(input);
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {"true", "false", "true"}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		//assertEquals("true;34;56;34;",RuntimeLog.globalLog.toString());
	}
 ...
 * @throws Exception
 */
public void sink_test() throws Exception{
	devel = false;
	grade = true;
	String prog = "imageGenGreen";
	String input = prog
